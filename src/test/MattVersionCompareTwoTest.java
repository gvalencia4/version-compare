...
import static main.MattVersionCompareTwo.MattVersionCompareStringsTwo;
import static org.junit.jupiter.api.Assertions.assertEquals;

class MattVersionCompareTwoTest {
    ...
    void EqualStringsReturnsZero() {
        ...
        assertEquals(MattVersionCompareStringsTwo(inputString1, inputString2), 0);
    }
    ...
    void DifferentStringsReturnOne() {
        ...
        assertEquals(MattVersionCompareStringsTwo(inputString1, inputString2), 1);
    }
