...
import static main.TomVersionCompare.TomVersionCompareStrings;
import static org.junit.jupiter.api.Assertions.assertEquals;

class TomVersionCompareTest {
    ...
    void EqualStringsReturnsZero() {
        ...
        assertEquals(TomVersionCompareStrings(inputString1, inputString2), 0);
    }
    ...
    void DifferentStringsReturnOne() {
        ...
        assertEquals(TomVersionCompareStrings(inputString1, inputString2), 1);
    }
